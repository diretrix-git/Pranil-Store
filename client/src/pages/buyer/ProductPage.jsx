    ...
    return (
      <div className="min-h-screen bg-slate-50">
        ...
        <div className="text-center py-20">
          ...
          <Link to="/" className="text-violet-600 font-semibold hover:underline">← Back to Home</Link>
        </div>
      </div>
    );
  }
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
            ...
            <div className="p-6 bg-gradient-to-br from-violet-50 to-indigo-50">
              ...
              {images.length > 1 && (
                <div className="flex gap-2 flex-wrap">
                  {images.map((img, i) => (
                    <motion.button key={i} whileTap={{ scale: 0.95 }} onClick={() => setActiveImg(i)}
            ...
            <div className="p-6 sm:p-8 flex flex-col">
              ...
              <div className="flex items-center gap-2 mb-4">
                <span className={`text-xs font-bold px-2.5 py-1 rounded-full ${outOfStock ? 'bg-red-100 text-red-600' : 'bg-green-100 text-green-700'}`}>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="flex items-center border border-slate-200 rounded-xl overflow-hidden">
                      <button onClick={() => setQty((q) => Math.max(1, q - 1))}
                        className="px-3 py-2.5 text-slate-600 hover:bg-slate-50 transition-colors font-bold">−</button>
