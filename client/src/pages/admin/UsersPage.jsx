                  ...
                  {users.map((u) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <span
                          className={`text-xs font-semibold px-2 py-0.5 rounded-full ${u.isActive !== false ? "bg-green-100 text-green-700" : "bg-slate-100 text-slate-500"}`}
                        >
                      ...
                      <td className="px-4 py-3 text-right">
                        <motion.button
                          whileTap={{ scale: 0.95 }}
                          onClick={() => toggleStatus.mutate({ id: u._id })}
