...
const features = [
  {
    icon: "🏪",
    title: "Multi-Vendor",
    desc: "Hundreds of independent sellers, each with their own store and product catalog.",
  },
  {
    icon: "🔒",
    title: "Secure",
    desc: "JWT authentication, httpOnly cookies, and encrypted passwords keep your account safe.",
  },
  {
    icon: "📦",
    title: "Order Tracking",
    desc: "Real-time order status updates from placement to delivery.",
  },
  {
    icon: "🧾",
    title: "Instant Invoices",
    desc: "Print-ready invoices generated automatically for every order.",
  },
  {
    icon: "⚡",
    title: "Fast & Reliable",
    desc: "Built on the MERN stack for speed and scalability.",
  },
  {
    icon: "🌍",
    title: "For Everyone",
    desc: "Whether you're a buyer, seller, or platform admin — MarketHub has you covered.",
  },
];
      ...
      <section className="bg-gradient-to-br from-violet-600 via-indigo-600 to-blue-600 text-white py-20 sm:py-28 px-4 text-center relative overflow-hidden">
        ...
        >
          ...
          <p className="text-violet-100 text-lg sm:text-xl leading-relaxed">
            A modern multi-vendor marketplace connecting buyers and sellers in
