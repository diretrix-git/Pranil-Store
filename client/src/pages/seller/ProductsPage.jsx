            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm min-w-[600px]">
                <thead className="bg-slate-50 border-b border-slate-200">
                  <tr>
                    {["Name", "Categories", "Price", "Stock", "Status", ""].map(
                      (h) => (
                        <th
                          key={h}
                ...
                <tbody>
                  {products.map((p) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <span
                          className={`text-xs font-semibold px-2 py-0.5 rounded-full ${p.isActive !== false ? "bg-green-100 text-green-700" : "bg-slate-100 text-slate-500"}`}
                        >
