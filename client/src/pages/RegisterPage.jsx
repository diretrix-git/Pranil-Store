              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input type="tel" name="phone" value={form.phone} onChange={handleChange} placeholder="+1 234 567 8900"
                    className={`w-full bg-slate-50 border rounded-xl px-4 py-3 text-sm text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-violet-400 focus:bg-white transition-all ${errors.phone ? 'border-red-400 bg-red-50' : 'border-slate-200'}`} />
                ...
                <div>
                  ...
                  <div className="relative">
                    <input type={showConfirm ? 'text' : 'password'} name="confirmPassword" value={form.confirmPassword} onChange={handleChange}
                      ...
                      className={`w-full bg-slate-50 border rounded-xl px-4 py-3 pr-11 text-sm text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-violet-400 focus:bg-white transition-all ${errors.confirmPassword ? 'border-red-400 bg-red-50' : form.confirmPassword && form.confirmPassword === form.password ? 'border-green-400' : 'border-slate-200'}`} />
