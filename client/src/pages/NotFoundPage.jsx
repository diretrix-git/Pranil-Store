      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <motion.div whileTap={{ scale: 0.97 }}>
            <Link to={homeLink}
              className="inline-block px-8 py-3 rounded-xl font-bold text-white bg-gradient-to-r from-violet-600 to-indigo-600 hover:opacity-90 transition-opacity shadow-md shadow-violet-200">
              ← Back to Home
            </Link>
          </motion.div>
          <motion.div whileTap={{ scale: 0.97 }}>
            <button onClick={() => navigate(-1)}
              className="inline-block px-8 py-3 rounded-xl font-semibold text-slate-600 bg-white border border-slate-200 hover:bg-slate-50 transition-colors">
              Go Back
            </button>
          </motion.div>
        </div>
